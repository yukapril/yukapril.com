...
1. 配置参数时，由于可配置参数太多了，所以注意查阅文档，不要网上乱抄。`swiper` 4 之前版本，有些写法差异，需要单独查阅下。不过咱们用不到这些老版本了。`swiper` 4～9（最新的就是9），API 基本上没差别，可以通用。英文官方文档[见此](https://swiperjs.com/swiper-api)，国内中文版[见此](https://www.swiper.com.cn/api/index.html)。
